...
<div x-data="formManagement()" x-init="init()" x-cloak class="space-y-8 relative">
    ...
    <button @click="showSidebar = true"
        ...
        <span style="writing-mode: vertical-rl;" class="text-[9px] font-black uppercase tracking-[0.3em] rotate-180 drop-shadow-md text-indigo-50">Form Filters</span>
    </button>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 gap-y-10 mt-4">
        ...
        <div class="relative flex flex-col bg-gradient-to-br from-indigo-50 to-blue-50 rounded-2xl shadow-lg shadow-indigo-500/20 border border-indigo-200 hover:-translate-y-2 transition-all duration-300 group cursor-pointer"
            ...
            <div class="p-4 text-right pt-4">
                <p class="text-xs font-bold tracking-wider text-blue-500 uppercase">Total Forms</p>
            ...
            <div class="mx-4 mb-4 border-t border-indigo-200 pt-2">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-[10px] text-indigo-700 font-bold uppercase tracking-tight">System Valid Forms</span>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <tr class="hover:bg-blue-50/40 transition-colors group">
                                    ...
                                    <td class="px-5 py-4 text-center whitespace-nowrap">
                                        <div class="flex flex-col items-center justify-center gap-1">
                                            <button @click="openViewModal(item)" class="w-full flex items-center gap-1.5 px-3 py-1.5 text-gray-600 hover:bg-gray-100 hover:text-gray-900 rounded-lg transition-all text-[10px] font-bold uppercase tracking-wider" title="View Details">
                                                <i class="fas fa-eye"></i> View
                                            </button>
                                            <button @click="openEditModal(item)" class="w-full flex items-center gap-1.5 px-3 py-1.5 text-gray-600 hover:bg-gray-100 hover:text-gray-900 rounded-lg transition-all text-[10px] font-bold uppercase tracking-wider">
                                                <i class="fas fa-edit"></i> Edit
                                            </button>
                                            <button @click="confirmDelete(item)" class="w-full flex items-center gap-1.5 px-3 py-1.5 text-gray-600 hover:bg-gray-100 hover:text-gray-900 rounded-lg transition-all text-[10px] font-bold uppercase tracking-wider">
    ...
    <div x-show="showDeleteModal" class="fixed inset-0 z-[70] overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true" style="display: none;">
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
            ...
            <div x-show="showDeleteModal" class="relative inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-3xl shadow-2xl sm:my-8 sm:align-middle sm:max-w-md sm:w-full sm:p-6 text-center border border-slate-100">
                ...
                <h3 class="text-xl font-black text-slate-800 mb-2">Delete Form</h3>
...
<script>
    function formManagement() {
        return {
            ...
            async bulkDelete() {
                if (!confirm(`Are you sure you want to permanently purge ${this.selectedIds.length} forms?`)) return;
